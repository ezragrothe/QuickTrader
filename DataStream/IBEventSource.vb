...
Imports IBApi
Public Class IBEventSource
    Implements EWrapper
    Private _client As EClient

    Public WriteOnly Property Client As EClient
...
#Region "IBApi.EWrapper"
    ...
    Private Sub EWrapper_HistoricalData(reqId As Integer, bar As IBApi.Bar) Implements EWrapper.historicalData, EWrapper.historicalDataUpdate
        InvokeIfRequired(Sub()
...
#Region "Event declarations"
    ...
    Event PnLSingle(sender As IBEventSource, e As PnLSingleEventArgs)
    Event PnL(sender As IBEventSource, e As PnLEventArgs)
    Event HistogramData(sender As IBEventSource, e As HistogramDataEventArgs)
    Event HeadTimestamp(sender As IBEventSource, e As HeadTimestampEventArgs)
    ...
    Event SmartComponents(sender As IBEventSource, e As SmartComponentsEventArgs)
    Event TickReqParams(sender As IBEventSource, e As TickReqParamsEventArgs)
