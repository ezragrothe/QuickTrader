...
'            newSwingTextObject = NewLabel(newRVTextPrefix & FormatNumberLengthAndPrefix(PriceRV, Chart.Settings("DecimalPlaces").Value) & " RV ", ColorConverter.ConvertFromString("#FF0067FF"), New Point(0, 0), True, , False)
...
'            If (cs.Direction = Direction.Down And Round(CurrentBar.High, 5) >= Round(cs.EndPoint.Y + PriceRV, 5)) OrElse
'                (cs.Direction = Direction.Up And Round(CurrentBar.Low, 5) <= Round(cs.EndPoint.Y - PriceRV, 5)) Then
'                'new swing
